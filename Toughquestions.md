379. Which AWS Cloud Adoption Framework (AWS CAF) capability belongs to the business perspective?
...
386. Which AWS Well-Architected Framework pillar focuses on structured and streamlined allocation of computing resources?

A. Reliability
B. Operational excellence
C. Performance efficiency Most Voted
D. Sustainability

387. Which AWS Cloud Adoption Framework (AWS CAF) capabilities belong to the governance perspective? (Choose two.)
...
C. Writing the business logic code. Most Voted
...
B. Amazon Cognito
C. AWS IAM Identity Center Most Voted
...
B. AWS Artifact
C. IAM credential report Most Voted
D. AWS Audit Manager
...
B. The ability to rightsize resources as demand shifts Most Voted
...
A. AWS Trusted Advisor Most Voted
B. Amazon CloudWatch
C. Amazon GuardDuty
...
A. EC2 Image Builder Most Voted
...
A. Culture evolution
B. Event management
C. Data monetization Most Voted
...
A. Benefits management Most Voted
B. Risk management
...
Which AWS service creates an encrypted IPsec tunnel over the internet between an on-premises network and a VPC using a 300 Mbps link? (Choose 1)

AWS Client VPN
AWS Site-to-Site VPN service
AWS Direct Connect
Amazon VPC
